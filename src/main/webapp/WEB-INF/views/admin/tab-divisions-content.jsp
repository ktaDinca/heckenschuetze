...
<script type="text/javascript">
    ...
    function saveDivision() {
        ...
        $.ajax({
            type: "post",
            url: "<spring:url value="/admin/divisions/edit" />",
            data: {
                id: divid,
                name: divname,
    ...
    function loadAllDivManagers() {
        $.ajax({
            type: "get",
            url: "<spring:url value="/admin/divisions/division-managers" />",
            success: function(data) {
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                for (var i = 0; i < data.divisions.length; i ++) {
                    ...
                    line += '<td>' + '<a id="edit_div_' + i + '"' + 'data-toggle="modal" href="#editDivisionModal">' + 'edit' + '</a>' +
                            '<td>' + '<a id="remove_div_' + i + '"' + ">" + 'delete' + '</a>' +
                            '</tr>';
